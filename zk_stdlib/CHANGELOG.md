...
* Adding a boolean flag for the parser chip due to a change of its structure (configuration now optional) [#200](https://github.com/midnightntwrk/midnight-zk/pull/200)
