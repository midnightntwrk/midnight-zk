//! Criterion benchmark for full_credential proving (k=17).
//!
//! ```sh
//! cargo bench -p midnight-zk-stdlib --bench prove_cred
//! ```
...
impl Relation for FullCredential {
    ...
    fn circuit(
        ...
        let holder_sk: AssignedField<_, K256Scalar, MultiEmulationParams> =
            secp256k1_curve.scalar_field_chip().assign(layouter, sk)?;
