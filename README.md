...
This repository implements the proof system used in **XXXX**, along with tooling for building zero-knowledge circuits.

## Repository Structure

- `curves`: Implementation of elliptic curves used in xxxx, concretely BLS12-381 and JubJub
- `proof-system`: Plonk proof system using KZG commitments
- `circuits`: Tooling for constructing ZK circuits
- `aggregator`: Toolkit for proof aggregation of xxxx-proofs.
...
Over time, our codebases have diverged from the upstream projects. These components are no longer maintained as forks and have evolved into standalone implementations tailored to XXXX's needs.
