...
use crate::{
    ...
    hash::ripemd160::{
        ...
        utils::{
            ...
            limb_lengths, limb_values, negate_spreaded, spread, u32_to_be_limbs, MASK_EVN_64,
        },
    },
    instructions::{
...
impl<F: CircuitField> RipeMD160Chip<F> {
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                let [R_11a, R_11b, R_10] =
                    res_val.map(|v| u32_to_be_limbs(v, [11usize, 11, 10])).transpose_array();
    ...
    fn assign_sprdd_11_11_10(
        ...
        let [evn_11a, evn_11b, evn_10] =
            evn_val.map(|v| u32_to_be_limbs(v, [11usize, 11, 10])).transpose_array();

        let [odd_11a, odd_11b, odd_10] =
            odd_val.map(|v| u32_to_be_limbs(v, [11usize, 11, 10])).transpose_array();
