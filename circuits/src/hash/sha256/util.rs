...
pub fn i2lebsp<const NUM_BITS: usize>(int: u64) -> [bool; NUM_BITS] {
    /// Takes in an FnMut closure and returns a constant-length array with
    /// elements of type `Output`.
...
/// Given a vector of words as vec![(lo: u16, hi: u16)], returns their sum: u32,
/// along with a carry bit.
