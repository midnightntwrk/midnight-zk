...
use crate::{field::AssignedNative, instructions::AssignmentInstructions, types::AssignedByte};
...
mod test {
        ...
        F: PrimeField + Ord,
    {
        ...
        fn synthesize(
            ...
            let parsed_output =
                scanner_chip.parse_static(&mut layouter, &self.automaton_index, &input)?;
            assert!(
