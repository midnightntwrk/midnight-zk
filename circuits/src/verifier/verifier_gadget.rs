...
impl<S: SelfEmulation> VerifierGadget<S> {
    ...
    /// * S_j is, either,
    ///      - (i)  the commitment to a fixed column corresp. to a simple,
    ///        multipl. selector, or,
    ///      - (ii) the constant commitment (in case the corresp. identity id_j
    ///        has been fully evaluated and, thus, the resulting scalar is part
    ///        of the constant term of the linearization poly),
