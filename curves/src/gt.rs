...
mod tests {
    ...
    fn test_gt_bilinearity() {
        ...
        let a = Fq::from_u64s_le(&[1, 2, 3, 4])
            .unwrap()
            .invert()
            .unwrap()
            .square();
        let b = Fq::from_u64s_le(&[5, 6, 7, 8])
            .unwrap()
            .invert()
            .unwrap()
            .square();
