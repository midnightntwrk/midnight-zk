...
use halo2_proofs::{
    ...
    plonk::{
        Advice, Column, ConstraintSystem, Constraints, ErrorFront as Error, Fixed, Selector,
        TableColumn,
    },
    poly::Rotation,
};
...
impl SpreadTableConfig {
    ...
    ///    Concretely,
    /// in row offset+i the values `postponed[2*i]`,  `postponed[2*i + 1]` are
    /// checked
...
mod tests {
    ...
    use halo2_proofs::{
        ...
        dev::MockProver,
        plonk::{Advice, Circuit, Column, ConstraintSystem, ErrorFront as Error},
    };
