...
pub mod tests {
    ...
    where
        ...
        ArithChip: ArithInstructions<F, Assigned> + FromScratch<F>,
    {
        let r = OsRng.next_u32() as i64;
        let s = OsRng.next_u32() as i64;
        ...
        ArithChip: ArithInstructions<F, Assigned> + FromScratch<F>,
    {
        ...
        let r = i64_to_element::<Assigned::Element>(&(OsRng.next_u32() as i64));
        let mut cost_model = true;
        [
        ...
        ArithChip: ArithInstructions<F, Assigned> + FromScratch<F>,
    {
        ...
        let r = (OsRng.next_u32() as i64) / 2;
        let s = (OsRng.next_u32() as i64) / 2;
        let mut cost_model = true;
        [
            (0, 0, 0, true),
            (r, s, r + s + r * s, true),
