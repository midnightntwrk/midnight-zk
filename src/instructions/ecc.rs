...
pub mod tests {
        ...
        EccChip::Point: InnerValue<Element = C::CryptographicGroup> + Clone,
    {
        ...
        let r = C::CryptographicGroup::random(OsRng);
        let s = C::CryptographicGroup::random(OsRng);
        let wrong = C::CryptographicGroup::random(OsRng);
        ...
        EccChip::Point: InnerValue<Element = C::CryptographicGroup> + Clone,
    {
        ...
        [
            ...
            C::CryptographicGroup::random(OsRng),
        ]
        .into_iter()
        .for_each(|x| {
            let inputs = vec![x];
        ...
        EccChip::Point: InnerValue<Element = C::CryptographicGroup> + Clone,
    {
        let n = 3;
        let inputs = (0..n)
            .map(|_| C::CryptographicGroup::random(OsRng))
            .collect::<Vec<_>>();
        let scalars = (0..n)
            .map(|_| (C::Scalar::random(OsRng), C::Scalar::NUM_BITS as usize))
            .collect::<Vec<_>>();
        let expected = inputs
            .clone()
            .into_iter()
    ...
    where
        ...
        EccChip::Point: InnerValue<Element = C::CryptographicGroup> + Clone,
    {
        let base = C::CryptographicGroup::random(OsRng);
        ...
        EccChip::Point: InnerValue<Element = C::CryptographicGroup> + Clone,
    {
        ...
        [
            ...
            (C::CryptographicGroup::random(OsRng), true),
        ]
        .into_iter()
