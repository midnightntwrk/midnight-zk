...
use halo2_proofs::{
    ...
    plonk::{Advice, Column, ConstraintSystem, ErrorFront as Error, Fixed, Selector, TableColumn},
    poly::Rotation,
};
...
impl<F: PrimeField> Pow2RangeChip<F> {
    fn assert_row_lower_than_2_pow_n(
        &self,
...
mod tests {
    ...
    impl<F: PrimeField> Circuit<F> for TestCircuit<F> {
        ...
        fn configure(meta: &mut ConstraintSystem<F>) -> Self::Config {
            ...
            Pow2RangeChip::configure(meta, &columns, tag_col, q_pow2range, t_tag, t_val)
        }
