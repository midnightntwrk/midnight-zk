...
use blstrs::{ExtendedPoint as Jubjub, ExtendedPoint, SubgroupPoint};
...
impl MapToCurveCPU<Jubjub> for Jubjub {
    fn map_to_curve(u: &<Jubjub as CircuitCurve>::Base) -> SubgroupPoint {
        ...
        <ExtendedPoint as CofactorGroup>::clear_cofactor(&extended_point)
    }
}
