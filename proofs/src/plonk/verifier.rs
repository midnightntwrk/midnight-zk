...
>(
    ...
    // TODO: implement potential speed-up: collect all fully evaluated identities and accumulate
    // them with the correct power of y -> in the end, only a single scalar multiplication is needed
    // for all full evaluations
