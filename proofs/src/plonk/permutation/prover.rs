...
impl Argument {
        ...
        CS::Commitment: Hashable<T::Hash>,
    {
        ...
        // Pre-generate blinding values for all sets to allow parallel computation.
        let all_blindings: Vec<Vec<F>> = (0..num_sets)
        ...
        // Step C: Apply corrections, commit, and convert to coeff form.
        // Corrections are independent per set.
        ...
        // --- Phase 3: Write commitments to transcript in order. ---
        for (commitment, _) in &committed {
            transcript.write(commitment)?;
        }

        // --- Phase 4: FFT ---
        // TODO: These may be deferred to improve performance.
        let sets: Vec<_> = committed
            .into_par_iter()
            .map(|(_, poly)| CommittedSet {
