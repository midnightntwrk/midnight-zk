...
/// * S_j(X) is, either,
///      - (i)  the poly of a fixed column corresp. to a simple, multipl.
///        selector, or,
///      - (ii) 1 (in case the corres. identity id_j has been fully evaluated
///        and, thus, the resulting scalar is part of the constant term of the
///        linearization poly),
