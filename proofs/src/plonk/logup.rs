...
/// # Layout
///
/// After construction, `input_expressions` is organized as `[parallel_lookups][lookup_width]`:
/// - The outer dimension indexes each parallel lookup (each row that performs a lookup)
