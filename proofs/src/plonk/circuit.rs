...
pub struct ConstraintSystem<F: Field> {
    ...
    /// Marks simple selectors: 1 if selector is simple and multipl.,
    /// and 0 otherwise. This field is later repurposed to contain the fixed
    /// column index of a simple, multipl. selector, after its conversion to
    /// a fixed column.
