...
const NUM_INSTANCE_COLS: usize = 5;

#[cfg(feature = "committed-instances")]
const NUM_INSTANCE_COMS: usize = 2;
...
struct FieldConfig {
    ...
    instance_cols: [Column<Instance>; NUM_INSTANCE_COLS],
    s: Selector,
}
        ...
        + Ord,
{
    ...
    let mut public_inputs = vec![vec![]; NUM_INSTANCE_COLS];
    for i in 0..instances.len() {
        public_inputs[i % NUM_INSTANCE_COLS].push(instances[i]);
    }
    ...
    let accepted = {
        ...
        prepare::<E::Fr, KZGCommitmentScheme<E>, _>(
            ...
            #[cfg(feature = "committed-instances")]
            &[&public_inputs[NUM_INSTANCE_COMS..]],
