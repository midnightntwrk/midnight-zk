...
### Changed
* Prove path: `Value::assign` builds its `Error::Synthesis` lazily (it allocated a String per assigned advice cell), and the circuit config / flattened custom gates are moved rather than cloned [#532](https://github.com/midnightntwrk/midnight-zk/pull/532)
