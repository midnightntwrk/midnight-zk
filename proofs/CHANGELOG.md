...
### Changed
* Split linearization polynomial into homogeneous and affine parts, removing the generator point from the MSM [#313](https://github.com/midnightntwrk/midnight-zk/pull/313)
